...
# 195 "../aux_pin.c"
  ...
  OC5RS = cycle;
# 246 "../aux_pin.c"
  OC5CON = (0b110 << 0x00000000) | (0 << 0x00000003) |
           (0 << 0x00000004) | (0 << 0x0000000D);
...
# 289 "../aux_pin.c"
  ...
  if (state.mode == AUX_MODE_PWM) {
    ...
    if (cmdbuf[((cmdstart + 1) & (128 - 1))] == 0x00) {
...
# 715 "../aux_pin.c"
  ...
  TMR2 = 0x0000;
# 732 "../aux_pin.c"
  T2CON = (1 << 0x0000000F) | (1 << 0x00000003);
# 747 "../aux_pin.c"
  IC2CON = (0b011 << 0x00000000) | (0b00 << 0x00000005) |
           (0 << 0x00000007) | (0 << 0x0000000D);
# 763 "../aux_pin.c"
  IC1CON = (0b011 << 0x00000000) | (0b00 << 0x00000005) |
           (1 << 0x00000007) | (0 << 0x0000000D);
