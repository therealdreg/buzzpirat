...
# 323 "../i2c.c"
  ...
  if (speed == 0) {
    ...
    if (i2c_state.mode == 0) {
      ...
      if (bus_pirate_configuration.device_revision <= 0x3003) {
        bp_message_write_buffer(__builtin_tbladdress(BPMSG1066_str));
      }
...
void i2c_macro(unsigned int c) {
  ...
  case 1:
    ...
    bitbang_set_pins_high(0b0000001000000000 | 0b0000000100000000, 0);
...
void i2c_sniffer(_Bool interactive_mode) {
  ...
  _Bool old_sda = PORTBbits.RB9;
  _Bool old_scl = PORTBbits.RB8;
  ...
  for (;;) {
    ...
    new_sda = PORTBbits.RB9;
    new_scl = PORTBbits.RB8;
