...
uint8_t perform_selftest(_Bool show_progress, _Bool jumper_test) {
  ...
  check_result(PORTBbits.RB11, 1);



  bp_disable_pullup();
  bp_message_write_buffer(__builtin_tbladdress(BPMSG1168_str));
  check_result(PORTBbits.RB11, 0);
...
# 181 "../selftest.c"
  ...
  perform_adc_test(10, 0x307 - 0x50, 0x307 + 0x50);
# 228 "../selftest.c"
  if (jumper_test) {
    ...
    perform_adc_test(11, 0x307 - 0x50, 0x307 + 0x50);
  }



  bp_message_write_buffer(__builtin_tbladdress(BPMSG1173_str));
  perform_adc_test(9, 0x200 - 0x50, 0x200 + 0x50);
  ...
  if (jumper_test) {
    ...
    perform_adc_test(12, 0x200 - 0x50, 0x200 + 0x50);
  }
  ...
  TRISB &= ~(0b0000001000000000 + 0b0000000100000000 + 0b0000000010000000 + 0b0000000001000000);
  LATB |= (0b0000001000000000 + 0b0000000100000000 + 0b0000000010000000 + 0b0000000001000000);
  bp_delay_ms(100);
