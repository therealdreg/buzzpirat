...
uint8_t jtag_write_bit(const _Bool value) {
  ...
  jtag_clock_high();
  uint8_t input_bit = PORTBbits.RB7;
  jtag_clock_low();
  return input_bit;
}
...
void jtag_data_high(void) {
  TRISBbits.TRISB9 = ~jtag_settings.hiz;
  PORTBbits.RB9 = jtag_settings.hiz;
  bp_delay_us(20);
}
...
void jtag_clock_high(void) {
  TRISBbits.TRISB8 = ~jtag_settings.hiz;
  PORTBbits.RB8 = jtag_settings.hiz;
  bp_delay_us(100);
}
...
void jtag_tms_high(void) {
  TRISBbits.TRISB6 = ~jtag_settings.hiz;
  PORTBbits.RB6 = jtag_settings.hiz;
  bp_delay_us(20);
}
